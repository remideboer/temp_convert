<?php
/*
 * Oefen API voor HTTP GET request met URL-parameters, 
...
if(isset($_GET['waarde']) && isset($_GET['type']) && is_numeric($_GET['waarde'])){
    $waarde = $_GET['waarde'];
    if($_GET['type'] === 'c2f'){
        echo $waarde * 9/5 + 32;
    } elseif($_GET['type'] === 'f2c') {
        echo ($waarde - 32) * 5/9;
    } elseif($_GET['type'] === 'c2k') {
        echo $waarde + 273.15;
    } elseif($_GET['type'] === 'k2c') {
        echo $waarde - 273.15;
    } else {
